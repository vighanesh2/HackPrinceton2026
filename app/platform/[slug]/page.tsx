...
export default function ButtonPromptDetailPage({ params }: PageProps) {
  const [copied, setCopied] = useState(false)
  const item = buttonPrompts.find((entry) => entry.slug === params.slug)
  ...
  if (!item) {
    return (
      <main className="platform platform-app">
        ...
        <p className="platform-detail-miss">This component was not found.</p>
        <Link href="/platform" className="platform-detail-backlink">
          Browse buttons
        </Link>
      </main>
    )
