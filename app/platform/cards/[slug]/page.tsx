...
export default function CardPromptDetailPage({ params }: PageProps) {
  const [copied, setCopied] = useState(false)
  const item = cardPrompts.find((entry) => entry.slug === params.slug)
  ...
  if (!item) {
    return (
      <main className="platform platform-app">
        ...
        <p className="platform-detail-miss">This card was not found.</p>
        <Link href="/platform/cards" className="platform-detail-backlink">
          Browse cards
        </Link>
      </main>
    )
